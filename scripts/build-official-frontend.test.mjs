...
test('Android adaptation stylesheet covers safe areas and mobile interaction constraints', async () => {
  ...
  assert.match(css, /100dvh/u, 'dynamic viewport height keeps the IME from covering the app')
  assert.match(css, /min-height:\s*44px/u, 'interactive controls retain an accessible touch target')
